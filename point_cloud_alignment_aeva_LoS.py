...
df = pd.read_csv("/home/asrl/Documents/Research/vicon_data_extraction/postprocessing/vicon_markers.csv")
if df.empty:
...
# print(aeva_distances)

# use distances + line of sight unit vectors (hardcoded) to get points
aeva_1 = np.array([0.977338, 0.156708, -0.142317]) * aeva_distances[0] / 1000.0
aeva_2 = None
aeva_3 = np.array([0.998685, 0.043323, 0.027399]) * aeva_distances[2] / 1000.0
aeva_4 = np.array([0.983735, -0.159817, 0.082002]) * aeva_distances[3] / 1000.0
aeva_5 = None
aeva_6 = None
# aeva_5 = np.copy(aeva_4) # NOT accurate (seems like z axis between vicon and aeva is off by ~1 degree)
# aeva_5[2] = aeva_4[2] - (271.7534 / 1000.0)
# aeva_6 = np.copy(aeva_4)
# aeva_6[2] = aeva_6[2] - (537.6618 / 1000.0)
aeva_7 = np.array([0.982813, 0.158158, 0.095206]) * aeva_distances[6] / 1000.0
...
unfiltered_aeva_pc = [aeva_1, aeva_2, aeva_3, aeva_4, aeva_5, aeva_6, aeva_7] # b
